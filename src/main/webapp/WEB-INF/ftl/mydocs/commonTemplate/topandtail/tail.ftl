   <div id="ft">    
      <div class='ft-share'>
        <a href='http://weibo.com/6014060156/manage' class='png weibo' target="_blank"></a>
        <a href='http://user.qzone.qq.com/2128852332/infocenter?ptsig=9i1-zcfQGsl-AhN5xn3Ajb6weK0clEdA9oO-xpB01u0_' class='png qq' target="_blank"></a>
     <#--   <a href='javasript:void(0)' class='png weixin'></a>-->
        <a href='http://www.linkedin.com/company/jobplus?trk=biz-companies-cym' class='png linkedin' target="_blank"></a>
      </div>
      ...
      <div class="fusion-row">
		<div class="fusion-copyright-content">
		  <div class="fusion-copyright-notice" style="padding-bottom: 0px;">
			...
			<a target="_blank" href="http://www.miitbeian.gov.cn" class='beian-code' title="苏ICP备16046992号" rel="nofollow">苏ICP备16046992号</a>
			</div>
		 </div>
		</div>
	  </div>
