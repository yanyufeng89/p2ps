		    ...
		    <div class="uc-head-bottom">
				  <div style="float:left" id="mytopiccontent">
				   ...
				   <div style="float:left">
				    <p>我的书籍</p>
				    <p class="dll">
					    <a id='bookshare' href='/myCenter/getSharedBookList' <#if (sharedBookPage)??>class="current"</#if>>分享
					     (<#if (Session.operationSum.booksharesum)??>${Session.operationSum.booksharesum}</#if>)
					    </a>
					    <a id='bookcollect'  href='/myCenter/getCollectedBookList' <#if (collectedBookPage)??>class="current"</#if>>收藏
					          ...
					          <#list sharedBookPage.list as list>
					            <li>
					              <div class='w356 fs14 fc3 ib titlehidden'>
                                   ...
                                   <div class='w140 ib recommendhidden'>
