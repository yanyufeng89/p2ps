		    ...
		    <ul id="accordion">
		      <li class="open">
		         ...
		         <ul class="submenu" style="display:block">
	                 <li id="mydocument"><a href="/myCenter/getMyDocsUploaded"  class="current"><span class="icon-doc <#if (Session.user.usertype==2)>c-icon<#else>u-icon</#if>"></span>我的文档</a></li>
	                 ...
	                 <li id="mybook"><a href="/myCenter/getBookDetail"><span class="icon-book <#if (Session.user.usertype==2)>c-icon<#else>u-icon</#if>"></span>我的书籍</a></li>
		      ...
		      <li>
		         <div class="my-doc link"><p><b class="iconfont list-icon <#if (Session.user.usertype==2)>c-icon<#else>u-icon</#if>"></b>我的账户<b class="iconfont up-arrow doc-arrow-btn"></b></p></div>
		         <ul class="submenu">
		       ...
		       <li>
		         <div class="my-order link"><p><b class="iconfont list-icon <#if (Session.user.usertype==2)>c-icon<#else>u-icon</#if>"></b>我的订单<b class="iconfont up-arrow doc-arrow-btn"></b></p></div>
		         <ul class="submenu">
		       ...
		       <li>
		         <div class="my-order link"><p><b class="iconfont list-icon <#if (Session.user.usertype==2)>c-icon<#else>u-icon</#if>"></b>我的财富<b class="iconfont up-arrow doc-arrow-btn"></b></p></div>
		         <ul class="submenu">
