                      ...
                      <#if (record)??>
	                       ...
	                       <div class='infor-right'>
                             ...
                             <div class='brief book-height course-height tool-height'>
                               <#if (record.intro)??>
                               <div class='showbrief bookbrief' data-brief='${record.intro?trim}'>
                                <span class="tip">简介:</span>
                                ${record.intro?trim}
                                <#if record.intro?length gt 230>
					   ...
					   　　  <div class='purchase-book'><a href='${record.supplierUrl}' target='_blank' class='purchaseurl zg-btn-white'>购买本书</a></div>
						 <div class="shareto">
						 ...
						 <#list record.relatedList as samelist>
						  <li>
							 <div class='related-book-right'>
							   <a  href='/books/getBookDetail?id=${samelist.data_id}'  target='_blank'  title='${samelist.title}'><span class='SidebarListNav-label'>${samelist.title}</span></a>
