		      ...
		      <li>
		       ...
		       <li class="open">
		         ...
		         <ul class="submenu" style="display:block">
	                ...
	                <li><a href="/51jobplusCore/account/getDetailListByRecord?changetype=2" class="current"><span class="icon-wealthspending"></span>财富支出</a></li>
		          </ul>
		      </li>
		    </ul>
		</ul>
		 ...
		 <div class='fortunecontent maincontent'>
		   ...
		   <div class='docs-list-box'>
		     <div class='status-box'>
			   <div class='w335 ib'>财富支出</div>
			   <div class='w335 ib'>消耗量</div>
