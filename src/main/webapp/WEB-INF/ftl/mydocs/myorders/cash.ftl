     ...
     <#include "/mydocs/commonTemplate/topandtail/top.ftl"/>
      <div id="bd">
		      ...
		      <li>
		       ...
		       <li class="open">
		         ...
		         <ul class="submenu"  style="display:block">
	                 ...
	                 <li><a href="/user/cash"  class="current"><span class="icon-cash <#if (Session.user.usertype==2)>c-icon<#else>u-icon</#if>"></span>已经支出</a></li>
		...
		<div class="uc-main">
		   ...
		   <div id="allcash" class='maincontent'>
			<div class="uc-news">
