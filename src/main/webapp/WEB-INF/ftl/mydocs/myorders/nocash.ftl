     ...
     <#include "/mydocs/commonTemplate/topandtail/top.ftl"/>
      <div id="bd">
		      ...
		      <li>
		       ...
		       <li class="open">
		         ...
		         <ul class="submenu"  style="display:block">
	                 ...
	                 <li><a href="/user/nocash"  class="current"><span class="icon-nocash <#if (Session.user.usertype==2)>c-icon<#else>u-icon</#if>"></span>尚未支付</a></li>
		          </ul>
		      </li>
		       <li>
		...
		<div class="uc-main">
		   ...
		   <div id="allnocash"  class='maincontent'>
			<div class="uc-news">
