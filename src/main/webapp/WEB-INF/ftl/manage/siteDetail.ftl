...
<html class="expanded">
  ...
  <body id='sitetop'>
		         ...
		         <div class='media-right'>
		           ...
		           <div class="operate">
					 ...
					 <a href="javascript:;" class="meta-item zu-autohide js-report" data-commentbyid="${booklist.userid}" data-topiccommentid="${booklist.id}" data-reporttype='7'>
					  ...
					  <a href="javascript:;" name="addcomment" class="meta-item toggle-comment js-cancel" data-recommend="${booklist.id}" data-commentby='${booklist.commentby}' data-tableName='11'>
    ...
    <script type="text/javascript" src="/manage/js/mycenter/pj_mycentersite.js"></script>
  </body>
