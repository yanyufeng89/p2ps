  ...
  <body id='coursetop'>
    <div class="page">
      ...
      <div class='bookdescrition'>
		<span>聘加知识库>课程<#list record.coursestype?split(",") as item><#assign types=item?split(":")/>>${types[1]}</#list></span>
      </div>
      <div id="content">
                      ...
                      <#if (record)??>
	                       <div class='infor-right'>
                             ...
                             <div class='press'>
                                ...
                                <a href='javascript:void(0)' data-url='${record.coursesurl}' target='_blank' id='courseurl'>${record.coursesurl}</a>
                             </div>
		         ...
		         <div class='media-right'>
		           ...
		           <div class="operate">
					 ...
					 <a href="javascript:;" class="meta-item zu-autohide js-report" data-commentbyid="${booklist.userid}" data-topiccommentid="${booklist.id}" data-reporttype='3'>
					  ...
					  <a href="javascript:;" name="addcomment" class="meta-item toggle-comment js-cancel" data-recommend="${booklist.id}" data-commentby='${booklist.commentby}' data-tableName='9'>
     ...
     <a id="#coursebacktop" title="回到顶部" href="#coursetop" style="bottom: 300px; display: none;"></a>
     <#include "/mydocs/commonTemplate/detailjs/detailjs.ftl"/>
     <script type="text/javascript" src="/manage/js/mycenter/pj_mycentercourse.js"></script>
