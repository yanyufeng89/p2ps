  ...
  <body id='articletop'>
    <div class="page">
      ...
      <div class='bookdescrition'>
		<span>聘加知识库>文章<#list record.articletype?split(",") as item><#assign types=item?split(":")/>>${types[1]}</#list></span>
      </div>
      <div id="content">
                      ...
                      <#if (record)??>
	                       <div class='infor-right'>
                             ...
                             <div class='press'>
                                ...
                                <a href='javascript:void(0)' data-url='${record.articleurl}' target='_blank' id='articleurl'>${record.articleurl}</a>
                             </div>
		         ...
		         <div class='media-right'>
		           ...
		           <div class="operate">
					 ...
					 <a href="javascript:;" class="meta-item zu-autohide js-report" data-commentbyid="${booklist.userid}" data-topiccommentid="${booklist.id}" data-reporttype='1'>
					  ...
					  <a href="javascript:;" name="addcomment" class="meta-item toggle-comment js-cancel" data-recommend="${booklist.id}" data-commentby='${booklist.commentby}' data-tableName='10'>
						 ...
						 <#list record.relatedList as samelist>
						  <li>
							 <div class='related-book-right'>
							   <span>
							        <a href='/article/getArticleDetail?id=${samelist.data_id}'>${samelist.title}</a>
     ...
     <a id="#articlebacktop" title="回到顶部" href="#articletop" style="bottom: 300px; display: none;"></a>
     <#include "/mydocs/commonTemplate/detailjs/detailjs.ftl"/>
     <script type="text/javascript" src="/manage/js/mycenter/pj_mycenterarticle.js"></script>
  </body>
