...
//	private int slider = 1;// 前后显示页面长度
	 ...
	 * 初始化参数
	 */
	public void initialize(Long countparm,int pageNoparm){
//				System.out.println("initialize（）   count=="+this.count);
		this.count = countparm;
		this.pageNo = pageNoparm;
		//1
		this.first = 1;
...
//	public void initialize(Long countparm, int pageNoparm) {
//		// System.out.println("initialize（） count=="+countparm);
////		countparm = countparm;
////		pageNoparm = pageNoparm;
//		// 1
//		this.first = 1;
//
//		this.last = (int) (countparm / (this.pageSize < 1 ? 20 : this.pageSize) + first - 1);
//
//		if (countparm % this.pageSize != 0 || this.last == 0) {
//			this.last++;
//		}
//
//		if (this.last < this.first) {
...
//
//		if (pageNoparm <= 1) {
//			pageNoparm = this.first;
//			this.firstPage = true;
//		}
//
//		if (pageNoparm >= this.last) {
//			pageNoparm = this.last;
//			this.lastPage = true;
//		}
//
//		if (pageNoparm < this.last - 1) {
//			this.next = pageNoparm + 1;
//		} else {
//			this.next = this.last;
//		}
//
//		if (pageNoparm > 1) {
//			this.prev = pageNoparm - 1;
//		} else {
//			this.prev = this.first;
//		}
//
//		// 2
//		if (pageNoparm < this.first) {// 如果当前页小于首页
//			pageNoparm = this.first;
//		}
//
//		if (pageNoparm > this.last) {// 如果当前页大于尾页
//			pageNoparm = this.last;
//		}
//
//	}
