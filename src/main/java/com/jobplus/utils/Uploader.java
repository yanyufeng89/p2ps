...
public class Uploader {
	...
	/**
	 * this method get the request of value
	 * 
	...
	/**
	 * this method set the request of value
	 * 
	 * @param enName The request to set.
	 */
	...
	public void upload() throws Exception {
		...
		try {
			...
			while (fii.hasNext()) {
				...
				this.size = fis.openStream().available();
				if (!fis.isFormField()) {
	...
	private String getName(String fileName) {
		return this.fileName = "" + UUIDGenerator.getUUID()
