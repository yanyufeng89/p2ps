...
<html class="expanded">
  ...
  <body id='articletop'>
    <div class="page">
						 ...
						 <#list record.relatedList as samelist>
						  <li>
							 <div class='related-book-right'>
							   <span>
							        <a href='/51jobplusCore/article/getArticleDetail?id=${samelist.data_id}'>${samelist.title}</a>
     ...
     <script type="text/javascript" src="/51jobplusCore/manage/js/mycenter/pj_mycenterarticle.js"></script>
  </body>
