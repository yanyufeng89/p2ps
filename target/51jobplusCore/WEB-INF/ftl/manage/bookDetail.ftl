...
<html class="expanded">
  ...
  <body id='booktop'>
    <div class="page">
                      ...
                      <#if (record)??>
	                       <div class='infor-left'>
	                           <#if (record.bookimg)??>
	                            ...
	                            <#else>
	                              <img src="/image/thief.jpg" class="book-logo" alt="">
	                           </#if>
	                       </div>
				   ...
				   <#if (booklist.likedIds)??&&booklist.likedIds?length gt 0>
				      <#if booklist.likedIds?index_of(",")==-1>
					   ...
					   <#else>
						 ...
						 <a href="javascript:;" name="addcomment" class="meta-item toggle-comment js-cancel" data-recommend="${booklist.id}" data-commentby='${booklist.commentby}'>
					  ...
					  <#else>
						 ...
						 <a href="javascript:;" name="addcomment" class="meta-item toggle-comment js-cancel" data-recommend="${booklist.id}" data-commentby='${booklist.commentby}' data-tableName='7'>
					        <i class="zg-icon zg-icon-comment-del"></i>删除
					     </a>
				    </#if>
						 ...
						 <#list record.relatedList as samelist>
						  <li>
						     <div class='related-book-left'>
							   <#if (samelist.url)??>
							      <a href='/books/getBookDetail?id=${samelist.data_id}' target="_self"><img src="${samelist.url}" class="zm-item-img-avatar"></a>
							   <#else>
							      <a href='/books/getBookDetail?id=${samelist.data_id}' target="_self"><img src="/image/thief.jpg" class="zm-item-img-avatar"></a>
							   </#if>
							 </div>
     ...
     <script type="text/javascript" src="/manage/js/mycenter/pj_mycenterbook.js"></script>
  </body>
